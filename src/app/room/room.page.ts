...
export class RoomPage implements AfterViewInit {
  ...
  constructor(private plt:Platform,private room:RoomService,private nav: ActivatedRoute,  private router: Router, private http: HttpClient, private socket: SocketService, public toastController: ToastController, private userS: UserService) { }
